...
const Figma_Tip = () => {
  return (
    <div className="w-[540px] h-[675px] bg-black border border-red-500 relative">
      ...
      >
        <h3 className="text-[118px] z-40 leading-[1.05] text-white">Quick Figma Tips</h3>
      ...
      />
      <img src="./save-now.png" className="absolute top-[430px] w-[280px] h-[108px] z-50" />
      <img src="./figma-logo.png" className="h-[260px] w-[187px] absolute bottom-0 right-2" />
    </div>
  );
};
